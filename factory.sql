...
GRANT SELECT, INSERT, UPDATE, DELETE ON DATABASE Unit TO engineer;
GRANT SELECT, INSERT, UPDATE, DELETE ON DATABASE Unit_type TO engineer;
GRANT SELECT, INSERT, UPDATE, DELETE ON DATABASE Process TO engineer;
GRANT SELECT ON DATABASE Operation TO engineer;
GRANT SELECT ON DATABASE Product TO engineer;

CREATE ROLE worker;
GRANT CONNECT ON DATABASE nedobezhkin_pv_db TO worker;
GRANT USAGE ON SCHEMA factory TO worker;
GRANT SELECT ON DATABASE Unit TO worker;
GRANT SELECT ON DATABASE Unit_type TO worker;
GRANT SELECT ON DATABASE Process TO worker;
